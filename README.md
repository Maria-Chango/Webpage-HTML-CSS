...
Project Objective
The main goal of this project was to build a lightweight, high-performance personal landing page from scratch to practice semantic HTML5 and advanced CSS3 techniques, ensuring a professional presentation for recruitment and academic purposes.

Technologies & Tools
HTML5: Used for semantic structuring of the content (header, main, section, article, footer).
...
Technical Features
Responsive Design: The layout uses a grid system (grid-template-columns: repeat(auto-fit, ...)) to adapt to different screen sizes.
...
└── images/             # Directory for profile pictures and technology icons
...
License
This project was developed by María Chango as part of her professional development in Information Systems Engineering.
